...
@testset "No side constraints" begin
    ...
    # Chama o otimizador
    x_opt, flag, norma, norma_block = Wall_E(f,df,x0,ci,cs,false,100)
...
@testset "Many side constraints" begin
    ...
    # Chama o otimizador
    x_opt, flag, norma, norma_block = Wall_E(f,df,x0,ci,cs,false,500)
    ...
    # Chama o otimizador
    x_opt, flag, norma, norma_block = Wall_E(f,df,x0,ci,cs,false)
